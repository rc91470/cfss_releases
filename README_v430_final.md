# ![CFSS Logo](https://img.shields.io/badge/CFSS-v4.3.0-blue?style=for-the-badge&logo=desktop)
...
## 🚀 Quick Download - Latest Release (Windows v4.3.0, macOS v4.2.4)
...
Current Release: Windows v4.3.0, macOS v4.2.4
...
- **XSR Circuit Support** - Extended CSW circuit rules to XSR circuits`n- **Unified Display Logic** - XSR multi-jumper circuits show Port 1 location columns`n- **Correct Serial Selection** - XSR circuits use Port 1 jumper serial for multi-jumper configurations`n- **Fixed Save Results** - Saved reports now show correct serials for XSR circuits`n- **All previous v4.2.4 features** - High-DPI fixes, auto-updater, SharePoint integration
...
### Windows (v4.3.0 - Available Now)
1. **Download** the ZIP file using the link above
2. **Extract** to your desired location  
3. **Run** `CFSS_v4.3.0.exe` from the extracted folder
